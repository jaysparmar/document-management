...
<div class="container-fluid py-4">
    ...
    <div class="col-lg-8 mb-lg-0 mb-4">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h6 class="mb-0">{{ __('client.recent_documents') }}</h6>
            </div>
            <div class="card-body p-3">
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center">{{ __('client.no_documents_found') }}</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h6 class="mb-0">{{ __('client.categories_distribution') }}</h6>
            </div>
            <div class="card-body p-3">
                @foreach($documentsByCategory as $category)
                    <div class="mb-3">
                        ...
                        <div class="progress">
                            @php
                                $percentage = ($documentStats['total_documents'] > 0)
                                    ? ($category->count / $documentStats['total_documents']) * 100
                                    : 0;
                            @endphp
    ...
    <div class="col-lg-12 mb-4">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h6 class="mb-0">{{ __('client.recent_activity_timeline') }}</h6>
            </div>
            <div class="card-body p-3">
                <div class="timeline timeline-one-side">
                    ...
                    @empty
                        <p class="text-center">{{ __('client.no_recent_activities') }}</p>
                    @endforelse
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h6 class="mb-0">{{ __('client.storage_statistics') }}</h6>
            </div>
            <div class="card-body p-3">
                <div class="progress-wrapper">
                    <div class="progress-info mb-4">
                        <div class="progress-percentage">
                            <span class="text-sm font-weight-bold">{{ __('client.storage_used') }}</span>
                        </div>
                        @php
                        ...
                        <small class="text-muted">
                            {{ number_format($documentStats['storage_used'] / (1024 * 1024), 2) }} {{ __('client.mb_used') }}
                        </small>
                    </div>
                </div>
    ...
    <div class="col-lg-6 mb-4">
        <div class="card shadow-sm">
            <div class="card-header pb-0">
                <h6 class="mb-0">{{ __('client.category_analytics') }}</h6>
            </div>
            <div class="card-body p-3">
                <div class="chart">
