                    ...
                    <div class="row">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="rounded-3 border p-3">
                                        <h6 class="mb-2 text-sm">{{ __('client.created') }}</h6>
                                ...
                                <div class="col-md-6">
                                    <div class="rounded-3 border p-3">
                                        <h6 class="mb-2 text-sm">{{ __('client.last_modified') }}</h6>
                                        <p class="mb-1 text-sm">
                                            <i class="fas fa-calendar-alt text-primary me-2"></i>
                        ...
                        <div class="col-md-4">
                            <div class="rounded-3 bg-gray-100 p-4">
                                <h6 class="mb-3">{{ __('client.document_information') }}</h6>
                                <ul class="list-unstyled mb-0">
                                    ...
                                    <li class="mb-3">
                                        <span class="text-muted text-sm">{{ __('client.category') }}</span>
                                        <p class="font-weight-bold mb-0 text-sm">
                                            {{ $document['details']['category'] }}
                                        </p>
                                    </li>
                                    <li>
                                        <span class="text-muted text-sm">{{ __('client.file_size') }}</span>
                                        <p class="font-weight-bold mb-0 text-sm">
                        ...
                        <table class="align-items-center mb-0 table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex px-2 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">
                                                    ...
                                                    <span class="badge bg-gradient-success me-2">{{ __('client.current') }}</span>
                                                    @else
                                                    <span class="badge bg-gradient-secondary me-2">{{ __('client.previous') }}</span>
                                                    @endif
                                                </h6>
                                            </div>
                                        </div>
                                    ...
                                    <td>
                                        <button class="btn btn-link text-dark mb-0 px-3 view-document" data-path="{{ $version['url'] }}">
                                            <i class="fas fa-eye me-2"></i>{{ __('client.view') }}
                                        </button>
                                    </td>
                                </tr>
                                @endforeach
                        ...
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-muted mb-0 mt-1 text-sm">
                                    {{ __('client.comment_by', ['user' => $activity['by']]) }} (<small>{{ $activity['email'] }}</small>)
                                </p>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="comments-section">
                        ...
                        <div class="d-flex mb-4">
                            <div class="flex-shrink-0">
                                <div class="icon icon-shape bg-gradient-primary icon-sm rounded-circle d-flex align-items-center justify-content-center text-center shadow">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="documentViewerModalLabel">
                    {{ __('client.document_viewer') }}
                </h5>

                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="{{ __('client.close') }}"></button>
            </div>
